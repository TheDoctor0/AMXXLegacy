...
public plugin_init()
{
	...
	bind_pcvar_num(create_cvar("amx_help_display_msg"     , "0" , .has_min = true, .min_val = 0.0, .has_max = true, .max_val = 1.0), CvarDisplayClientMessage);
	bind_pcvar_num(create_cvar("amx_help_display_msg_time", "0", .has_min = true, .min_val = 0.0), CvarDisplayMessageTime);
