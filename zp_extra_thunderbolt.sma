...
#define WEAPON_NAME		"Thunderbolt"
...
public plugin_natives()
	register_native("zp_give_item_thunderbolt", "Get_Thunderbolt", 1);
...
public zp_fw_core_infect_post(id, attacker) Remove_Thunderbolt(id)
