...
new const MODELS[][]={
				"models/csobc/v_zgun.mdl",
				"models/csobc/p_zgun.mdl",
				"models/csobc/w_zgun.mdl"
}
new const SOUNDS[][]= {
				"weapons/zgun-1.wav",
...
#define WEAPONLIST		"csobc_zgun"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud90.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public ham_item_deploy_post(weapon_ent){
	...
	set_pdata_float(id, 83, 0.5, 5),set_pdata_float(weapon_ent, 48, 1.0, 4)
}
public ham_weapon_primaryattack(weapon_entity) {
	...
	set_pdata_float(id,111,get_gametime()+0.5)
...
public ham_weapon_reload(weapon_entity) {
	...
	set_pdata_float(weapon_entity, 48, 2.7, 4)
...
public plugin_natives()
	register_native("zp_give_item_zgun", "zp_give_item_zgun", 1);
public zp_give_item_zgun(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
