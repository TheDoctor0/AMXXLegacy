...
new const g_weapon_entity[]=	"weapon_ak47"
new const g_weaponbox_model[]=	"models/w_ak47.mdl"

#define WEAPON_NAME		"Skull-4"
...
new const MODELS[][]={
				"models/csobc/v_skull4.mdl",
				"models/csobc/p_skull4.mdl",
				"models/csobc/w_skull4.mdl"
}
new const SOUNDS[][]= {
				"weapons/skull4-1.wav",
				"weapons/skull4_clipin.wav",
				"weapons/skull4_clipout.wav",
				"weapons/skull4_draw.wav"
}
#define WEAPONLIST		"csobc_skull4"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud87.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_skull4", "zp_give_item_skull4", 1);
public zp_give_item_skull4(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
