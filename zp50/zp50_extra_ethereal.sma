...
new const MODELS[][]={
				"models/csobc/v_ethereal.mdl",
				"models/csobc/p_ethereal.mdl",
				"models/csobc/w_ethereal.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_ethereal"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud74.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_ethereal", "zp_give_item_ethereal", 1);
public zp_give_item_ethereal(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
