...
new const MODELS[][]={
				"models/csobc/v_balrog5.mdl",
				"models/csobc/p_balrog5.mdl",
				"models/csobc/w_balrog5.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_balrog5"
new const SPRITES[][]=	{
				"sprites/csobc/640hud2.spr",
				"sprites/csobc/640hud78.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public ham_traceattack_post(pEntity,attacker,Float:flDamage,Float:direction[3],ptr,damage_type) {
	...
	if(g_charge[attacker])
	{
		...
		{	
			...
			{
				damage=random_float(100.0, 250.0)
...
public plugin_natives()
	register_native("zp_give_item_balrog5", "zp_give_item_balrog5", 1);
public zp_give_item_balrog5(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
