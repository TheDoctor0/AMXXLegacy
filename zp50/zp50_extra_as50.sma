...
new const MODELS[][]={
				"models/csobc/v_as50.mdl",
				"models/csobc/p_as50.mdl",
				"models/csobc/w_as50.mdl"
}
new const SOUNDS[][]= {
				"weapons/as50-1.wav",
...
public plugin_natives()
	register_native("zp_give_item_as50", "zp_give_item_as50", 1);
public zp_give_item_as50(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
