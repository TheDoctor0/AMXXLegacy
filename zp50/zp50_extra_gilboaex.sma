...
new const MODELS[][]={
				"models/csobc/v_gilboaex.mdl",
				"models/csobc/p_gilboaex.mdl",
				"models/csobc/w_gilboaex.mdl"
}
new const SOUNDS[][]= {
				"weapons/gilboaex-1.wav",
				"weapons/gilboaex_clipin1.wav",
				"weapons/gilboaex_clipin2.wav",
				"weapons/gilboaex_clipout.wav"
}
#define WEAPONLIST		"csobc_gilboaex"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud116.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_gilboaex", "zp_give_item_gilboaex", 1);
public zp_give_item_gilboaex(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
