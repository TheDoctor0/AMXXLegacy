...
new const MODELS[][]={
				"models/csobc/v_m1911a1.mdl",
				"models/csobc/p_m1911a1.mdl",
				"models/csobc/w_m1911a1.mdl"
}
new const SOUNDS[][]= {
				"weapons/coltm1911a1-1.wav",
				"weapons/coltm1911a1_clipin.wav",
				"weapons/coltm1911a1_clipout.wav",
				"weapons/coltm1911a1_slideback.wav"
}
#define WEAPONLIST		"csobc_m1911a1"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud114.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public ham_weapon_primaryattack(weapon_entity) {
	...
	play_weapon_animation(id, get_pdata_int(weapon_entity,51,4)?ANIM_SHOOT_1:ANIM_SHOOT_1+1)
...
public ham_weapon_reload(weapon_entity) {
	...
	play_weapon_animation(id,clip?ANIM_RELOAD:ANIM_RELOAD+1)
...
public ham_weapon_idle(ent) {
	...
	play_weapon_animation(id, get_pdata_int(ent,51,4)?ANIM_IDLE:ANIM_IDLE+1)
...
public plugin_natives()
	register_native("zp_give_item_m911a1", "zp_give_item_m911a1", 1);
public zp_give_item_m911a1(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
