...
new const MODELS[][]={
				"models/csobc/v_mg36xmas.mdl",
				"models/csobc/p_mg36xmas.mdl",
				"models/csobc/w_mg36xmas.mdl"
}
new const SOUNDS[][]= {
				"weapons/mg36xmas-1.wav",
				"weapons/mg36xmas_clipin.wav",
				"weapons/mg36xmas_clipout.wav",
				"weapons/mg36xmas_draw.wav"
}
#define WEAPONLIST		"csobc_mg36xmas"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud82.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_precache() {
		...
		g_index_shell=precache_model("models/csobc/shell_ice.mdl")
...
public ham_weapon_primaryattack(weapon_entity) {
	...
	set_pdata_float(weapon_entity, 48, RATE_OF_FIRE+0.9, 4)
...
public plugin_natives()
	register_native("zp_give_item_mg36xmas", "zp_give_item_mg36xmas", 1);
public zp_give_item_mg36xmas(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
