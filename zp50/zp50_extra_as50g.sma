//=========================================================================
#define CSW_WEAPON		CSW_G3SG1
new const g_weapon_entity[]=	"weapon_g3sg1"
new const g_weaponbox_model[]=	"models/w_g3sg1.mdl"

#define WEAPON_NAME		"As-50 Pink Gold"
#define WEAPON_COST		0

#define DAMAGE			150.0
#define RECOIL			0.5
#define RATE_OF_FIRE		0.5
#define CLIP			10
#define AMMO			90
...
new const MODELS[][]={
				"models/csobc/v_as50g.mdl",
				"models/csobc/p_as50g.mdl",
				"models/csobc/w_as50g.mdl"
}
new const SOUNDS[][]= {
				"weapons/as50-1.wav",
				"weapons/as50_clipin1.wav",
				"weapons/as50_clipin2.wav",
				"weapons/as50_clipout1.wav",
				"weapons/as50_clipout2.wav",
				"weapons/as50_draw.wav"
}
#define WEAPONLIST		"csobc_as50"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud6.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public message_weappickup(msg_id,msg_dest,id)if(is_user_connected(id)&&get_msg_arg_int(1)==CSW_WEAPON)set_weaponlist(id,1)
...
public ham_weapon_primaryattack(weapon_entity) {
	...
	set_pdata_float(weapon_entity, 48, 1.1, 4)
...
public plugin_natives()
	register_native("zp_give_item_as50g", "zp_give_item_as50g", 1);
public zp_give_item_as50g(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
