...
#define WEAPON_NAME		"Spas-12 Cobra"
#define WEAPON_COST		0

#define DAMAGE			60.0
#define DAMAGE_EX		50.0
#define RECOIL			0.5
...
new const MODELS[][]={
				"models/csobc/v_spas12ex2.mdl",
				"models/csobc/p_spas12ex2.mdl",
				"models/csobc/w_spas12ex2.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_spas12ex2"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud70.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_spas12ex2", "zp_give_item_spas12ex2", 1);
public zp_give_item_spas12ex2(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
...
public damage_pre(attacker)
{
	...
	if(is_valid_weapon(weapon_ent)) {
		damage_set(attacker, (get_pdata_int(weapon_ent, 74, 4)&SKULL11_MODE)?(DAMAGE_EX):(DAMAGE))
		return 1
	}
	return 0
}