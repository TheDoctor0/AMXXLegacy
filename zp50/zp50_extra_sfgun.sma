...
new const MODELS[][]={
				"models/csobc/v_sfgun.mdl",
				"models/csobc/p_sfgun.mdl",
				"models/csobc/w_sfgun.mdl"
}
new const SOUNDS[][]= {
				"weapons/sfgun-1.wav",
				"weapons/sfgun_clipin.wav",
				"weapons/sfgun_clipout.wav",
				"weapons/sfgun_draw.wav"
}
#define WEAPONLIST		"csobc_sfgun"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud58.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_sfgun", "zp_give_item_sfgun", 1);
public zp_give_item_sfgun(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
