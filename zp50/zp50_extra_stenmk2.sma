...
new const MODELS[][]={
				"models/csobc/v_stenmk2.mdl",
				"models/csobc/p_stenmk2.mdl",
				"models/csobc/w_stenmk2.mdl"
}
new const SOUNDS[][]= {
				"weapons/stenmk2-1.wav",
				"weapons/stenmk2_boltpull.wav",
				"weapons/stenmk2_clipin.wav",
				"weapons/stenmk2_clipout.wav"
}
#define WEAPONLIST		"csobc_stenmk2"
new const SPRITES[][]=	{
...
public plugin_natives()
	register_native("zp_give_item_stenmk2", "zp_give_item_stenmk2", 1);
public zp_give_item_stenmk2(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
