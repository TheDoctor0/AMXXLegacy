...
new const MODELS[][]={
				"models/csobc/v_skull7.mdl",
				"models/csobc/p_skull7.mdl",
				"models/csobc/w_skull7.mdl"
}
new const SOUNDS[][]= {
				"weapons/m249ex-1.wav",
				"weapons/m249ex_clipin1.wav",
				"weapons/m249ex_clipin2.wav",
				"weapons/m249ex_clipin3.wav",
				"weapons/m249ex_clipout1.wav",
				"weapons/m249ex_clipout2.wav"
}
#define WEAPONLIST		"csobc_skull7"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud51.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_skull7", "zp_give_item_skull7", 1);
public zp_give_item_skull7(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
