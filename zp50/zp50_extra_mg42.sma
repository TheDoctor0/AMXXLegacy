...
#define WEAPON_NAME		"Mg42"
#define WEAPON_COST		0

#define DAMAGE			40.0
#define RECOIL			0.5
#define RATE_OF_FIRE		0.115
#define CLIP			95
#define AMMO			200
...
new const MODELS[][]={
				"models/csobc/v_mg42.mdl",
				"models/csobc/p_mg42.mdl",
				"models/csobc/w_mg42.mdl"
}
new const SOUNDS[][]= {
				"weapons/mg42-1.wav",
				"weapons/mg42_clipin1.wav",
				"weapons/mg42_clipin2.wav",
				"weapons/mg42_clipout.wav",
				"weapons/mg42_close.wav",
				"weapons/mg42_open.wav"
}
#define WEAPONLIST		"csobc_mg42"
new const SPRITES[][]=	{
...
public plugin_natives()
	register_native("zp_give_item_mg42", "zp_give_item_mg42", 1);
public zp_give_item_mg42(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
