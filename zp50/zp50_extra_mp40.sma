...
new const MODELS[][]={
				"models/csobc/v_mp40.mdl",
				"models/csobc/p_mp40.mdl",
				"models/csobc/w_mp40.mdl"
}
new const SOUNDS[][]= {
				"weapons/mp40-1.wav",
				"weapons/mp40_boltpull.wav",
				"weapons/mp40_clipin.wav",
				"weapons/mp40_clipout.wav"
}
#define WEAPONLIST		"csobc_mp40"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud110.spr",
				"sprites/csobc/640hud111.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_mp40", "zp_give_item_mp40", 1);
public zp_give_item_mp40(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
