...
#define WEAPON_NAME		"Janus-5"
#define WEAPON_COST		0

#define SHOTS_MODE		29
#define DAMAGE			50.0
...
new const MODELS[][]={
				"models/csobc/v_janus5.mdl",
				"models/csobc/p_janus5.mdl",
				"models/csobc/w_janus5.mdl"
}
new const SOUNDS[][]= {
				"weapons/janusmk5-1.wav",
...
#define WEAPONLIST		"csobc_janusmk5"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud98.spr"
}
...
public plugin_natives()
	register_native("zp_give_item_janus5", "zp_give_item_janus5", 1);
public zp_give_item_janus5(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
