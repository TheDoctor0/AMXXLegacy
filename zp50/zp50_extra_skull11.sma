...
new const MODELS[][]={
				"models/csobc/v_skull11.mdl",
				"models/csobc/p_skull11.mdl",
				"models/csobc/w_skull11.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_skull11"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud71.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public fm_cmdstart(id,uc_handle,seed){
	...
	if((get_uc(uc_handle,UC_Buttons)&IN_ATTACK2)&&get_pdata_float(id,83,5)<=0.0&&get_pdata_float(weapon_ent,46,4)<=0.0){
		...
		set_pdata_float(weapon_ent,48,0.5,4)
	}
}
...
public plugin_natives()
	register_native("zp_give_item_skull11", "zp_give_item_skull11", 1);
public zp_give_item_skull11(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
