...
#define WEAPON_NAME		"M-1887 Xmas"
...
#define ANIM_IDLE		0
#define ANIM_SHOOT_1		random_num(5, 12)
#define ANIM_DRAW		1

#define BODY_NUMBER		0
new const MODELS[][]={
				"models/csobc/v_m1887xmas.mdl",
				"models/csobc/p_m1887xmas.mdl",
				"models/csobc/w_m1887xmas.mdl"
}
new const SOUNDS[][]= {
				"weapons/m1887xmas-3.wav",
				"weapons/m1887_draw.wav",
				"weapons/m1887_insert.wav",
				"weapons/m1887_reafter.wav",
				"weapons/m1887_restart.wav",
				"weapons/m1887xmas_shoot6.wav",
				"weapons/m1887xmas_shoot8.wav"
}
#define WEAPONLIST		"csobc_m1887xmas"
new const SPRITES[][]=	{
				"sprites/csobc/640hud3.spr",
				"sprites/csobc/640hud102.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public fm_cmdstart(id,uc_handle,seed){
	...
	if((get_uc(uc_handle,UC_Buttons)&IN_ATTACK2)&&get_pdata_float(id,83,5)<=0.0&&get_pdata_float(weapon_ent,46,4)<=0.0){
		if(get_pdata_int(weapon_ent, 74, 4)&SKULL11_MODE){
			set_pdata_int(weapon_ent, 74, get_pdata_int(weapon_ent, 74, 4)&~SKULL11_MODE, 4)
			emit_sound(id, CHAN_WEAPON, SOUNDS[2], VOL_NORM, ATTN_NORM, 0, PITCH_NORM)
		}else{
			set_pdata_int(weapon_ent, 74, get_pdata_int(weapon_ent, 74, 4)|SKULL11_MODE, 4)
			emit_sound(id, CHAN_WEAPON, SOUNDS[3], VOL_NORM, ATTN_NORM, 0, PITCH_NORM)
		}
		set_pdata_float(weapon_ent,46,0.3,4)
		set_pdata_float(weapon_ent,47,0.3,4)
	}
}
...
public ham_weapon_primaryattack(weapon_entity) {
	...
	set_pdata_float(weapon_entity,46,0.25,4)
	set_pdata_float(weapon_entity, 48, 1.25, 4)
	...
	set_pdata_float(id,111,get_gametime()+0.55)
	}
...
public plugin_natives()
	register_native("zp_give_item_m1887xmas", "zp_give_item_m1887xmas", 1);
public zp_give_item_m1887xmas(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
