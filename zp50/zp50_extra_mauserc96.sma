...
new const MODELS[][]={
				"models/csobc/v_mauserc96.mdl",
				"models/csobc/p_mauserc96.mdl",
				"models/csobc/w_mauserc96.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_mauserc96"
new const SPRITES[][]=	{
...
public plugin_natives()
	register_native("zp_give_item_mauserc96", "zp_give_item_mauserc96", 1);
public zp_give_item_mauserc96(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
