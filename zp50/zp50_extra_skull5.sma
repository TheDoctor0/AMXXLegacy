...
new const MODELS[][]={
				"models/csobc/v_skull5.mdl",
				"models/csobc/p_skull5.mdl",
				"models/csobc/w_skull5.mdl"
}
new const SOUNDS[][]= {
...
#define WEAPONLIST		"csobc_skull5"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud62.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
new g_msgWeaponList,g_wpn_variables[10],bool:g_iWeapList[33],g_iszWeaponKey,g_index_smoke,g_index_shell,g_itemid
...
public ham_item_addtoplayer(weapon_entity,id)if(is_valid_weapon(weapon_entity))set_weaponlist(id,1),g_iWeapList[id]=true
...
public plugin_natives()
	register_native("zp_give_item_skull5", "zp_give_item_skull5", 1);
public zp_give_item_skull5(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
