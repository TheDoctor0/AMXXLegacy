...
#define WEAPON_NAME		"Uts-15 Pink Gold"
#define WEAPON_COST		0

#define DAMAGE			85.0
#define RECOIL			0.5
#define RATE_OF_FIRE		0.8
#define CLIP			8
#define AMMO			32
...
new const MODELS[][]={
				"models/csobc/v_uts15g.mdl",
				"models/csobc/p_uts15g.mdl",
				"models/csobc/w_uts15g.mdl"
}
new const SOUNDS[][]= {
				"weapons/uts15-1.wav",
				"weapons/uts15_draw.wav",
				"weapons/uts15_insert.wav",
				"weapons/uts15_reload.wav"
}
#define WEAPONLIST		"csobc_uts15"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud80.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_uts15g", "zp_give_item_uts15g", 1);
public zp_give_item_uts15g(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
