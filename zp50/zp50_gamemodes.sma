...
new cvar_gamemode_delay, cvar_prevent_consecutive, cvar_show_hud
...
public plugin_init()
{
	...
	cvar_show_hud = register_cvar("zp_round_start_show_hud", "1")
...
{
	precache_sound("csobc/vox/1.wav")
	precache_sound("csobc/vox/2.wav")
	precache_sound("csobc/vox/3.wav")
	precache_sound("csobc/vox/4.wav")
	precache_sound("csobc/vox/5.wav")
	precache_sound("csobc/vox/6.wav")
	precache_sound("csobc/vox/7.wav")
	precache_sound("csobc/vox/8.wav")
	precache_sound("csobc/vox/9.wav")
	precache_sound("csobc/vox/10.wav")
	precache_sound("csobc/vox/20.wav")
}
...
public event_round_start()
{
	...
	cd=floatround(get_pcvar_float(cvar_gamemode_delay))
	set_task(1.0,"task",TASK_CD,_,_,"b")
}
...
public task(taskid)
{
	...
	if(get_pcvar_num(cvar_show_hud))
		client_print(0, print_center, "Zombie zaatakuja za: %d sekund", cd)
		
	if(cd==10) zp_thunder()
	if(cd<11){
		static sound[64]
		formatex(sound, charsmax(sound), "csobc/vox/%d.wav", cd)
