...
new const MODELS[][]={
				"models/csobc/v_sfsmg.mdl",
				"models/csobc/p_sfsmg.mdl",
				"models/csobc/w_sfsmg.mdl"
}
new const SOUNDS[][]= {
				"weapons/sfsmg-1.wav",
				"weapons/sfsmg_clipin1.wav",
				"weapons/sfsmg_clipin2.wav",
				"weapons/sfsmg_clipout1.wav",
				"weapons/sfsmg_draw.wav"
}
#define WEAPONLIST		"csobc_sfsmg"
new const SPRITES[][]=	{
				"sprites/csobc/640hud7.spr",
				"sprites/csobc/640hud65.spr"
}
//=========================================================================
#include <amxmodx>
#include <engine>
...
public plugin_natives()
	register_native("zp_give_item_sfsmg", "zp_give_item_sfsmg", 1);
public zp_give_item_sfsmg(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
