...
new const MODELS[][]={
				"models/csobc/v_psg1.mdl",
				"models/csobc/p_psg1.mdl",
				"models/csobc/w_psg1.mdl"
}
new const SOUNDS[][]= {
				"weapons/psg1-1.wav",
...
public plugin_natives()
	register_native("zp_give_item_psg1", "zp_give_item_psg1", 1);
public zp_give_item_psg1(id)
{
	new Ent=give_weapon(id)
	set_pdata_int(id,376+get_pdata_int(Ent,49,4),AMMO,5)
}
