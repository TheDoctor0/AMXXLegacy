...
* version 1.0b (Finally) (Edit By Hong Kong Eternal Server Admin "eS | [Z]ombie Jason.R" ) 
*    - Change The FlashBang icon Bug ( thanks cs-net server provide the sma file) 
* - pobrane z cs-puchatek.pl 
*/ 

#include <amxmodx> 

#define PLUGIN "Weapon Icon v1.1" 
#define VERSION "1.0b FIX" 
#define AUTHOR "Zenix (1.0b author Jason.R)" 

new iconstatus; 
new user_icons[33][192]; 
        ...
        if (is_user_ok(id)) { 
            if (equali(sprite, "") || !is_user_ok(id)) { 
                ...
                */ 
                ...
                if (wclip == 0 && wammo == 0) icon_color = {0, 255, 0} // outta ammo! 
                if (wclip == wammo || wclip > wammo) icon_color = {0, 255, 0} // last clip! 
                if (wammo > 0 && wclip == 0) icon_color = {0, 255, 0} // almost out! 
