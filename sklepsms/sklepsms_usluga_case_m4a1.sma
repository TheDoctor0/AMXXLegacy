...
#define PLUGIN "Sklep-SMS: Usluga Case M4A1"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_m4a1";

native set_player_case_m4a1(id,ilosc);
...
public ss_service_bought(id,amount) {
	set_player_case_m4a1(id, get_player_case_m4a1(id)+amount);
}
