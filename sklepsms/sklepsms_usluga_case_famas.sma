...
#define PLUGIN "Sklep-SMS: Usluga Case Famas"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_famas";

native set_player_case_famas(id,ilosc);
...
public ss_service_bought(id,amount) {
	set_player_case_famas(id, get_player_case_famas(id)+amount);
}
