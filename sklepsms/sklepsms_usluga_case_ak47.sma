...
#define PLUGIN "Sklep-SMS: Usluga Case Ak47"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_ak47";

native set_player_case_ak47(id,ilosc);
...
public ss_service_bought(id,amount) {
	set_player_case_ak47(id, get_player_case_ak47(id)+amount);
}
