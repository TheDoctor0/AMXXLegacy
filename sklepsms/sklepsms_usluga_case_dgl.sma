...
#define PLUGIN "Sklep-SMS: Usluga Case Deagle"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_deagle";

native set_player_case_deagle(id,ilosc);
native get_player_case_deagle(id);
...
public ss_service_bought(id,amount) {
	set_player_case_deagle(id, get_player_case_deagle(id)+amount);
}
