...
#define PLUGIN "Sklep-SMS: Usluga Case AWP"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_awp";

native set_player_case_awp(id,ilosc);
...
public ss_service_bought(id,amount) {
	set_player_case_awp(id, get_player_case_awp(id)+amount);
}
