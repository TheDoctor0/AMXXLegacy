...
#define PLUGIN "Sklep-SMS: Usluga Case MP5"
#define AUTHOR "O'Zone"
#define VERSION "1.0"

new const service_id[MAX_ID] = "case_mp5";

native set_player_case_mp5(id,ilosc);
...
public ss_service_bought(id,amount) {
	set_player_case_mp5(id, get_player_case_mp5(id)+amount);
}
