...
{
	new flags;
	AddMenu("Zrob Screeny", "amx_screenm", get_clcmd_flags("amx_screenm", flags) ? flags : ADMIN_KICK, "Commands Menu") 
	...
	AddMenu("Zbanuj Gracza (Config)", "amx_cbanmenu", get_clcmd_flags("amx_cbanmenu", flags) ? flags : ADMIN_BAN, "Commands Menu")
	AddMenu("Zbanuj Gracza (Nick)", "amx_nbanmenu", get_clcmd_flags("amx_nbanmenu", flags) ? flags : ADMIN_BAN, "Commands Menu")
	AddMenu("Sprawdz Gracza (Banid)", "amx_banid", get_clcmd_flags("amx_banid", flags) ? flags : ADMIN_BAN, "Commands Menu")
	AddMenu("Sprawdz Gracza (Aktywne Bany)", "amx_search", get_clcmd_flags("amx_search", flags) ? flags : ADMIN_BAN, "Commands Menu")
	AddMenu("Tryb Ukrytego Specta", "amx_spect", get_clcmd_flags("amx_spect", flags) ? flags : ADMIN_BAN, "Commands Menu")
	AddMenu("Zmutuj/Odmutuj Gracza", "amx_mute", get_clcmd_flags("amx_mute", flags) ? flags : ADMIN_BAN, "Commands Menu")
